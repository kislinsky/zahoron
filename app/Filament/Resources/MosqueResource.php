...
use App\Filament\Resources\MosqueResource\RelationManagers\ImagesRelationManager;
use App\Filament\Resources\MosqueResource\RelationManagers\ViewsRelationManager;
use App\Filament\Resources\MosqueResource\RelationManagers\WorkingHoursRelationManager;
use App\Models\Area;
use App\Models\City;
...
class MosqueResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Мечети';
            ...
            ->headerActions([
                Tables\Actions\Action::make('export')
                    ...
                    ->action(function (HasTable $livewire) {
                        ...
                        $mosques = $query->with(['city.area.edge', 'city.area', 'city'])
                            ->get()
                            ->map(function ($mosque) {
                                return [
                                    'ID' => $mosque->id,
                        ...
                        return (new FastExcel($mosques))->download('mosques.xlsx');
                    }),
            ])
            ->bulkActions([
