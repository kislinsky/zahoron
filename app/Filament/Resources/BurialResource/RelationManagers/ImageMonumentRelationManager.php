...
class ImageMonumentRelationManager extends RelationManager
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                ->label('Фотография')
                ->directory('uploads_burial_monument')
                ->image()
                ->required(),
    ...
    {
        return $table
            ->recordTitleAttribute('imageMonument')
            ->columns([
    ...
    // {
    //     return 'Фотографии памятника'; // Заголовок для RelationManager
    // }


    // public static function getModelLabel(): string
    // {
    //     return 'Фотография памятника'; // Метка для модели
    // }

    // public static function getPluralModelLabel(): string
    // {
    //     return 'Фотографии памятника'; // Метка для множественного числа
    // }
}
