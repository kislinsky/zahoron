...
class AdvicesRelationManager extends RelationManager
{
    protected static string $relationship = 'advices';
    protected static ?string $title = 'Советы';
