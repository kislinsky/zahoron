...
use App\Filament\Resources\ReviewCemeteryResource\Pages;
use App\Filament\Resources\ReviewCemeteryResource\RelationManagers;

class ReviewCemeteryResource extends Resource
{
    protected static ?string $model = ReviewCemetery::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?string $navigationLabel = 'Отзывы о кладбищах'; // Название в меню
    ...
    {
        return [
            'index' => Pages\ListReviewCemeteries::route('/'),
            'create' => Pages\CreateReviewCemetery::route('/create'),
