...
return new class extends Migration
{
    ...
    {
        Schema::table('comment_products', function (Blueprint $table) {
            $table->dropForeign('comment_products_category_id_foreign');
            $table->dropForeign('comment_products_organization_id_foreign');
            $table->dropForeign('comment_products_product_id_foreign');
        });
    }
};
