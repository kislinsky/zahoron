...
class ImageCrematoriumSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $oldData = DB::connection('zahoron_old')->table('image_crematoria')->get();

        // Переносим данные в \image_cemeteries\
        foreach ($oldData as $item) {
            DB::table('image_crematoria')->insert([
                ...
                'crematorium_id' => $item->crematorium_id, // Укажите корректный ID кладбища (см. ниже "ВАЖНО")
