...
class ImageOrganizationSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $oldData = DB::connection('zahoron_old')->table('image_organizations')->get();

        // Переносим данные в \image_cemeteries\
        foreach ($oldData as $item) {
            DB::table('image_organizations')->insert([
                ...
                'organization_id' => $item->organization_id , // Укажите корректный ID кладбища (см. ниже "ВАЖНО")
