...
class ImageMortuarySeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $oldData = DB::connection('zahoron_old')->table('image_mortuaries')->get();

        // Переносим данные в \image_cemeteries\
        foreach ($oldData as $item) {
            DB::table('image_mortuaries')->insert([
                ...
                'mortuary_id' =>  $item->mortuary_id , // Укажите корректный ID кладбища (см. ниже "ВАЖНО")
