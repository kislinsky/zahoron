...
<section class="block_content_organization_single our_products_single_organization">
    ...
    {{-- Swiper-обертка --}}
    <div class="swiper galerey_swiper" id="lightgallery">
    ...
    <div class="flex_single_organization">
        ...
        <div class="swiper_btn">
            <div class="swiper-button-prev swiper-button-prev-galerey">
                <img src="{{ asset('storage/uploads/Vector 9_2.svg') }}" alt="">
            </div>
            <div class="swiper-button-next swiper-button-next-galerey">
                <img src="{{ asset('storage/uploads/Vector 9_2.svg') }}" alt="">
            </div>
        </div>
    </div>
