<form method='get' action='{{route('review-organization.add')}}'class="block_content_organization_single our_products_single_organization">
    @csrf
    <div class="flex_single_organization">
        ...
        <input type="hidden" value='{{$organization->city_id}}'name="city_id">
