        ...
        <div class="grid_organization_single">
            <div class="main_content_organization_single">
                ...
                <div class="block_menu_single_organization">
                    ...
                    <div id_block=6 class="menu_single_organization">
                        <div class="text_black">Цены</div>
                    </div>
                    <div id_block=3 class="menu_single_organization">
                        <div class="text_black">Акции, скидки</div>
                    </div>
                    ...
                    <div id_block=5 class="menu_single_organization">
                        <div class="text_black">Прайслисты</div>
                    </div>
                    ...
                    <div class="block_content_organization_single">
                        <h2 class="title_li title_li_organization_single">О нас</h2>
                            <div class="text_black">
                                <div class="content_not_all">{!!custom_echo(contentCart($organization->content,$organization)450)!!}</div>
                                <div class="content_all">{!!contentCart($organization->content,$organization)!!}</div>
                            </div>
                        </div>
                    @endif
                ...
                <div id_block=2  id='block_reviews' class="flex_block_single_organization">
                    ...
                    @php
                        $add_review_second = true;
                    @endphp
                    {{ view('organization.components.add-reviews',compact('organization', "add_review_second"))}}
                </div>

                <div id_block=3  class="flex_block_single_organization">
                    {{view('organization.components.stocks-product',compact('product_stocks'))}}
                </div>
                ...
                <div id_block=5   class="flex_block_single_organization">   
                    {{view('organization.components.price-list',compact('price_lists'))}}
                    {{view('organization.components.remnants-ritual-goods',compact('remnants_ritual_goods'))}}
                </div>

                <div id_block=6   class="flex_block_single_organization">   
                    {{view('organization.components.min-price-ritual-services-provider',compact('organization','categories_organization'))}}
                </div>
        </div>    
