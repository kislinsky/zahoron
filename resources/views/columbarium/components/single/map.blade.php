...
<div class="block_map_organization_single">
    <div class="block_border_gray_map_organization_single">
        ...
        <div class="flex_single_organization">
            <div class="text_black text_flex"><img src="{{asset('storage/uploads/mdi_clock-outline.svg')}}" alt="">  {{$columbarium->timeEndWorkingNow()}}</div>
...
@if(count($similar_columbariums)>0)
    @foreach($similar_columbariums as $columbarium_one)
      myMap.geoObjects
