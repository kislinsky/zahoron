    ...
    <div class="container">  
        ...
        @if (isset($page))
            <div class='pages'>
                ...
                <a href='{{ route('account.burial.index') }}'class="btn_bac_gray <?php if($page==2){echo ' active_label_product';}?>">Геолокации</a>
                <a href='{{ route('account.services.index') }}'class="btn_bac_gray <?php if($page==3){echo ' active_label_product';}?>">Услуги</a>
                <a href='{{ route('account.burial-request.index') }}'class="btn_bac_gray <?php if($page==4){echo ' active_label_product';}?>">Поиск могил</a>
                <a href='{{ route('account.user.settings') }}'class="btn_bac_gray <?php if($page==5){echo ' active_label_product';}?>">Настройки</a>
                <a href='#'class="btn_bac_gray">Чат</a>
            </div>
        @else
            <div class='pages'>
                <a href='{{ route('home') }}'class="btn_bac_gray">Главная </a>
                <a href='{{ route('account.burial.index') }}'class="btn_bac_gray">Геолокации</a>
                <a href='{{ route('account.services.index') }}'class="btn_bac_gray">Услуги</a>
                <a href='{{ route('account.burial-request.index') }}'class="btn_bac_gray">Поиск могил</a>
                <a href='#'class="btn_bac_gray">Настройки</a>
                <a href='#'class="btn_bac_gray">Чат</a>
            </div>
        @endif
