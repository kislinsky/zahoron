            ...
            <form class="border_blue_block" method='post' action='{{ route('order.product.add.details') }}'>
                ...
                <div class="block_input" >
                    ...
                    <div class="block_ajax_input_search_cities">
                        <input class='input_search_cities' type="text" name="city_from" id="" placeholder="Город отправки" value='{{ selectCity()->title }}'>
                    </div>
                    @error('city_from')
                        <div class='error-text'>{{ $message }}</div>
                    @enderror
                ...
                <div class="block_input" >
                    ...
                    <div class="block_ajax_input_search_cities">
                        <input class='input_search_cities' type="text" name="city_to" id="" placeholder="Город прибытия" >
                    </div>
                    @error('city_to')
                        <div class='error-text'>{{ $message }}</div>
                    @enderror  
