...
<section class="order_page bac_gray">
    <div class="container">
        <div class="content_order_page">
            <h1 class="index_title">Крематории в г. {{$city->title}}</h1>    
        </div>
...
<div class="block_ritual_objects">
    ...
    <div class="container">
        <h2 class="title_middle mobile_title_ritual_object">Крематории на карте в г. {{$city->title}}</h2>
...
<section class="cemetery">
    <div class="container">
        ...
        <div class="block_info_place">
            <h2 class="title_middle">Информация о крематориях в г. {{$city->title}}</h2>
            <div class="text_black">
                {!!str_replace('{city}',$city->title,get_acf(4,'content_1'))!!}
            </div>
        </div>
    </div>
</section>
