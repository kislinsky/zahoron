    ...
    <div class="container">
        <div class="grid_organization_single">
            <div class="main_content_organization_single">
                ...
                {{view('church.components.single.main-block',compact('object','reviews'))}}
                ...
                <div id_block=1 class="flex_block_single_organization flex_block_single_organization_active">
                    ...
                    @endif
                    {{view('church.components.single.specifications',compact('object'))}}

                    {{view('church.components.single.our-organizations',compact('organizations_our'))}}

                    {{view('church.components.single.reviews_main',compact('reviews_main','reviews'))}}
                    ...
                    {{view('church.components.single.similar-objects',compact('similar_objects'))}}
                ...
                <div id_block=3  id='block_gallery' class="flex_block_single_organization">
                    {{view('church.components.single.gallery',compact('images'))}}

                </div>

                <div id_block=4  id='block_reviews' class="flex_block_single_organization">
                    {{view('church.components.single.reviews',compact('reviews'))}}
                    @php $add_review_second = true; @endphp
                    {{view('church.components.single.add-reviews',compact('object','add_review_second'))}}
                </div>
            ...
            <div class="sidebar">
                {{view('church.components.single.sidebar',compact('object'))}}
            </div>
        </div>
