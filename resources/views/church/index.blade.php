...
<section class="order_page bac_gray">
    <div class="container">
        <div class="content_order_page">
            <div class="index_title">Церкви в г. {{$city->title}}</div>    
        </div>
...
<div class="block_ritual_objects">
    ...
    <div class="container">
        <div class="title_middle mobile_title_ritual_object">Церкви на карте в г. {{$city->title}}</div>
...
<section class="cemetery">
    <div class="container">
        ...
        <div class="block_info_place">
            <div class="title_middle">Информация о церквях в г. {{$city->title}}</div>
