...
<div class="container">
    <form class='form_login form_with_email' method="POST" action="{{ route('accept.inn.information') }}">
        @csrf
        ...
        <div class="block_info">
            <div class="text_black_bold text_start">Телефон:</div>
            <div class="text_black">{{ $phone }}</div>
        ...
        <!-- Блок с существующими организациями -->
...
@endif
        ...
        <div class="grid_btn">
            ...
            <a href='{{ route('register') }}' class="btn_border_blue">Изменить</a>
        </div>
    </form>
</div>
