...
<div class="bac_black input_print_form">
    <div class='message'>
        ...
        <form action='{{ route('account.decoder.upload-icon.add') }}' method='post' enctype='multipart/form-data' class="form_settings">
            @csrf
            <div class="block_inpit_form_search input_print">
                <div class="input__wrapper">
                    <input style='display:none;' name="file" type="file" id="input__file" multiple class="input input__file_2">
...
<div class="account_container">
    <div class="flex_account">
            ...
            <section class="container_content_account settings">
                <div class="container">
                    <form action='{{ route('account.decoder.settings.update') }}' method="get" class="form_settings">
                        @csrf
                        ...
                        <div class="flex_search_form">
                            <div class="block_inpit_form_search">
                                ...
                                <input value='' type="password" autocomplete="off" name='password' placeholder='Старый пароль'>
                                @error('password')
                                    <div class='error-text'>{{ $message }}</div>
                                @enderror
                            </div>
                       ...
                       <div class="block_inpit_form_search">
                            <div class="title_middle settings_margin_form">Загрузка иконки</div>
