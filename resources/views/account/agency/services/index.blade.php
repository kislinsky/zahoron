...
<div class="bac_black input_print_form">
    <div class='message'>
        ...
        <form action='{{ route('account.organization.services.rent') }}' method='post' enctype='multipart/form-data' class="form_settings">
            @csrf
...
<section class="orders">
    <div class="container">
        ...
        <div class="flex_titles_account">
            ...
            <a href='{{ route('account.organization.services.filter',3) }}'class="btn_bac_gray <?php if($status==3){echo ' active_label_product';}?>">Исполненные </a>
            <a href='{{ route('account.organization.services.filter',5) }}'class="btn_bac_gray <?php if($status==5){echo ' active_label_product';}?>">На проверке </a>
            <a href='{{ route('account.organization.services.filter',2) }}'class="btn_bac_gray <?php if($status==2){echo ' active_label_product';}?>">В работе </a>
            <a href='{{ route('account.organization.services.filter',4) }}'class="btn_bac_gray <?php if($status==4){echo ' active_label_product';}?>">Новые</a>
        </div>
    @else
        <div class="flex_titles_account">
            <a href='{{ route('account.organization.services.filter',3) }}'class="btn_bac_gray">Исполненные </a>
            <a href='{{ route('account.organization.services.filter',5) }}'class="btn_bac_gray">На проверке </a>
            <a href='{{ route('account.organization.services.filter',2) }}'class="btn_bac_gray">В работе </a>
            <a href='{{ route('account.organization.services.filter',4) }}'class="btn_bac_gray">Новые </a>
        </div>
    @endif
                ...
                @foreach ($orders as $order)
                    ...
                    <div class="li_order">
                        ...
                        @if ($order->worker_id==null)
                            <a href='{{ route('account.organization.service.accept',$order->id) }}'class="blue_btn">Принять</a>
                        @else
                            @if($order->status==2)
