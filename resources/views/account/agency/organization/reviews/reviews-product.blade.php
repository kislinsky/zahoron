...
@section('content')
    ...
    <div class="flex_btn margin_top_down_20">
        <a href='{{route('account.agency.reviews.organization')}}' class="gray_btn">О компании</a>
        <a href='{{route('account.agency.reviews.product')}}' class="blue_btn">О товарах</a>
    </div>

    <div class="text_black_bold text_align_start">Все отзывы</div>

    {{view('account.agency.components.reviews.show-products',compact('reviews'))}}
