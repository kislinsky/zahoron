    ...
    @foreach ($reviews as $review)
        <div class="li_review_in_panel">
            ...
            <div class="flex_single_organization">
                ...
                <a href='{{route('account.agency.review.organization.delete',$review->id)}}'class="delete_product_organization"><img src="{{asset('storage/uploads/Vector (16).svg')}}" alt=""></a>

            </div>
        </div>        
    @endforeach
    {{ $reviews->withPath(route('account.agency.reviews.organization'))->appends($_GET)->links() }}

</div>


{{view('account.agency.components.reviews.form-update-review-organization')}}
{{view('account.agency.components.reviews.form-update-review-organization-organization-response')}}
