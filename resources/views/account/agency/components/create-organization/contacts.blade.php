...
<div class="block_inpit_form_search info_contacts_settings_organization">
    ...
    <div class="flex_input_form_contacts">
        <div class="block_input">
            ...
            <input placeholder='+758435348053' type="text" name='phone' >
        </div>
        <div class="block_input">
            <label for="">WhatsApp</label>
            <input placeholder='+758435348053' type="text" name='whatsapp' >
        </div>
    </div>
    <div class="flex_input_form_contacts">
        <div class="block_input">
            <label for="">Telegram</label>
            <input placeholder='+758435348053' type="text" name='telegram'>
        </div>
        <div class="block_input">
            <label for="">Email</label>
            <input placeholder='zahoron@gmail.com' type="email" name='email' >
        </div>
    </div>
    <div class="block_input">
        ...
        <div class="block_ajax_input_search_cities">
            ...
            <input type="hidden" name="city_id" class='city_id_input'  value='{{ selectCity()->id }}' >
        </div>
    </div>
    <div class="block_input">
        <label for="">Адрес агенства</label>
        <input placeholder='Москва, улица Льва Толстого, дом 16.' type="text" name='adres'>
    </div>
        ...
        <div class="coordinates_organization">
            <div class="flex_input_form_contacts">
                <div class="block_input">
                    ...
                    <input placeholder='' type="text" name='width' >
                </div>
                <div class="block_input">
                    <label for="">Долгота</label>
                    <input placeholder='' type="text" name='longitude'>
                </div>
            </div>
        </div>
    ...
    <div class="block_input">
        ...
        <input placeholder='ул. Филимонова' type="text" name='next_to' >
    </div>
    <div class="block_input">
