...
<div class="block_inpit_form_search">
    ...
    <label class='flex_input_checkbox '>
        <label class="switch">
            <input type="checkbox" name='available_installments' value='1' >
    ...
    <label class='flex_input_checkbox '>
        <label class="switch">
            <input type="checkbox" name='found_cheaper' value='1' >
            <span class="slider"></span>
        </label>
    ...
    <label class='flex_input_checkbox '>
        <label class="switch">
            <input type="checkbox" name='сonclusion_contract' value='1' >
            <span class="slider"></span>
        </label>
        Заключение договора
    </label>
    <label class='flex_input_checkbox '>
        <label class="switch">
            <input type="checkbox" name='state_compensation' value='1'>
            <span class="slider"></span>
        </label>
