<div class="block_inpit_form_search margin_top_20">
    ...
    <div class="ul_cemtery">
        ...
        <div class="li_cemetery_agent">
            ...
            <div  onclick='$(this).parent().remove()' class="delete_cart delete_cemetery"><img src="{{asset('storage/uploads/Закрыть (1).svg')}}" alt=""></div>
        </div>
