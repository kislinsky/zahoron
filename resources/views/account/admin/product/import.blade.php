...
@section('content')
    ...
    <div class="">
        <div class="title_middle">Импорт товаров из файла</div>  
        <form class="default_admin_form" method="post" enctype="multipart/form-data" action="{{ route('account.admin.parsing.product') }}">
            @csrf
