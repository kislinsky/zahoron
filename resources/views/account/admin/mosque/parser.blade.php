...
@section('content')
<div class="">
    <div class="title_middle">Импорт мечетей из файла</div>  
    <form class="default_admin_form" method="post" enctype="multipart/form-data" action="{{ route('account.admin.parsing.mosque') }}">
        @csrf
        ...
        <div class="block_input">
            ...
            <select name="import_type" id="import_type_cemetery" class="form-select">
                <option value="create">Создать новые мечети</option>
                <option value="update">Обновить мечети</option>
            </select>  
        </div>
