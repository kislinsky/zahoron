...
<section class='products_monuments_grave'>
    <div class="container">
        <h2 class="title">Заказать памятники на могилу в г. {{$city->title}} на маркетплейсе.</h2>
            ...
            <div class="swiper-button-prev swiper_button_prev_products_monuments_grave"><img src='{{asset('storage/uploads/Переключатель (1) copy.svg')}}'></div>
    </div>
</section>
@endif
