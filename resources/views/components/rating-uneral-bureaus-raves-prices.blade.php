...
$prices = ActivityCategoryOrganization::whereIn('category_children_id', [29, 30, 39])
            ...
            <tbody>
                @foreach($organizations as $organization)
                    @if($organization != null)
                        <?php 
                            $price_1 = $prices[$organization->id][29]->first() ?? null;
                            $price_2 = $prices[$organization->id][30]->first() ?? null;
                            $price_3 = $prices[$organization->id][39]->first() ?? null;
                        ?>
                        <tr>
