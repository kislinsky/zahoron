<form method='get' action='{{route('mortuary.review.add')}}'class="block_content_organization_single our_products_single_organization">
    @csrf
    <div class="flex_single_organization">
        <h2 class="title_li">Поделитесь мнением</h2>
        <input type="hidden" value='{{$mortuary->id}}'name="mortuary_id">
