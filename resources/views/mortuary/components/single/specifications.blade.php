<?php 
$interval=timeDifference($mortuary->time_start_work,$mortuary->time_end_work);
...
<div class="block_content_organization_single">
    <div class="ul_memorial_menu">
        <div class="li_memorial_menu">
            ...
            <div class="item_memorial_menu text_black"> Морг</div>
        </div>
        ...
        @if($mortuary->next_to!=null)
        <div class="li_memorial_menu">
            <div class="item_memorial_menu item_memorial_menu_1 text_gray">Рядом с</div>
            <div class="line_gray_menu"></div>
            <div class="item_memorial_menu text_black"> {{$mortuary->next_to}}</div>
        </div>
     @endif
        @if($mortuary->district_id!=null)
            <div class="li_memorial_menu">
                <div class="item_memorial_menu item_memorial_menu_1 text_gray">Район</div>
                <div class="line_gray_menu"></div>
                <div class="item_memorial_menu text_black"> {{$mortuary->district()->title}}</div>
            </div>
        @endif
        @if($mortuary->underground!=null)
            <div class="li_memorial_menu">
                <div class="item_memorial_menu item_memorial_menu_1 text_gray">Метро</div>
                <div class="line_gray_menu"></div>
                <div class="item_memorial_menu text_black"> {{$mortuary->underground}}</div>
            </div>
        @endif
        <div class="li_memorial_menu">
