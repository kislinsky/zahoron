    ...
    <div class="container">
        ...
        <div class="ul_advanyages_service">
            <div class="li_advantage_service">
                ...
                <div class="title_news">Безупречный вид</div>
            ...
            <div class="li_advantage_service">
                ...
                <div class="title_news">Надежная защита</div>
                <div class="title_rewies">Качественная покраска оград и других металлических объектов на кладбищах позволит вам забыть о ремонте могилы на 5 лет</div>
            </div>
            <div class="li_advantage_service">
                <img src="{{asset('storage/uploads/Subtract (1).svg')}}" alt="">
                <div class="title_news">Экономия времени и сил</div>
                <div class="title_rewies">Какой краской лучше покрыть 
могиле? Как правильно удалить 
Предоставьте это нам - и пол
результат через 1-2 дня!</div>
            </div>
        </div>
        <div class="single_flex_btn">
            <div class="blue_btn">Покрасить ограду</div>
